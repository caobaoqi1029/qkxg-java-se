...
export default defineConfig({
    base: "/qkxg-java-se/",
    title: "Java SE Study",
    description: "A docs for qkxg java SE",
    markdown: {
        math: true,
        lineNumbers: true
    },
    themeConfig: {
        ...
        nav: [
            {text: '离别开出花 🏠', link: '/'},
            {
                text: '🤬 JavaSE 基础内容',
                items: [
                    {text: '🤪 走进 Java 语言', link: '/study-01-basic/basic01.md'},
                    {text: '🥸 Index ', link: '/study-01-basic/index.md'},
                ]
            },
            {
                text: '🤖 其他内容',
                items: [
                    {text: '🤪 Java 9-17 新特性介绍', link: '/study-05-advance/advance01.md'},
                    {text: '🥸 Index ', link: '/study-05-advance/index.md'},
                ]
            },
            {
                text: "关于我 👩‍💻",
        ...
        sidebar: [
            ...
            {
                text: '💖 Java JVM 虚拟机',
                link: '/study-02-jvm/index.md',
                items: [
                    {text: '😶‍🌫️ 走进 JVM', link: '/study-02-jvm/jvm01.md'},
                ]
            },
            {
                text: '👺 Java JUC 并发编程',
                link: '/study-03-juc/index.md',
                items: [
                    {text: '🤔 再谈多线程', link: '/study-03-juc/juc01.md'},
                ]
            },
            {
                text: '🐲 Java NIO 网络编程',
                link: '/study-04-nio/index.md',
                collapsed: true,
                items: [
                    {text: '😃 基础内容', link: '/study-04-nio/nio01.md'},
                ]
            },
            {
                text: '🤖 其他内容',
                link: '/study-05-advance/index.md',
                collapsed: true,
                items: [
                    {text: '🤪 Java 9-17 新特性介绍', link: '/study-05-advance/advance01.md'},
                ]
